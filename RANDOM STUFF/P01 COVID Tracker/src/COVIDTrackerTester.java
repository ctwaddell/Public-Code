...
//
// Title:    COVIDTrackerTester - Test class for all the methods in COVIDTracker.java
...
{ 
   ...
   * @return String representing the arrays as a String separated by a '|'
   */
   ...
   * @return true if the addTest() works as expected and false if the addTest() doesn't wor
   */
  ...
  public static boolean testRemoveIndividual()
  {
    ...
    System.out.println(toString(pos, neg));
    ...
    System.out.println(toString(pos, neg) + "\n");  
    System.out.println("Number of successful tests = " + successCounter + "/6\n");
