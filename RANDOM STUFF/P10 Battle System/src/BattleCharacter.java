...
//
// Title:    BattleCharacter - A class for BattleCharacter objects which have their own
//                             respective stats to function for RPG games. various interactions
//                             and methods are included to aid function of a game.
...
public class BattleCharacter implements Comparable<BattleCharacter>{
  ...
  /**
   * equals compares two BattleCharacter objects and sees if they have the same ID
   * @return boolean true if they are the same object and false if they are different
   */
  public boolean equals(Object obj)
  {
    if(this.getClass().equals(obj.getClass()))
    {
      if(this.ID == ((BattleCharacter)obj).getID())
      {
        return true;
      }
    }
  ...
  /**
   * compareTo takes two BattleCharacter objects and compares their speed stats. If they have
   * the same speed stat, the lower ID object is greater
   * @return int, -1 if the first object is less than the second object,
   *               1 if the first object is greater than the second object,
   *               0 if the first object is the second object
   */
  public int compareTo(BattleCharacter compObj)
  {
    if(this.equals(compObj))
    {
      return 0;
    }
    ...
    {
      return 0; //this should never return anyways, so 0 indicates an error
    }
  }
